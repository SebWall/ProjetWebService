...
public class CommentaireFacadeREST extends AbstractFacade<Commentaire> {
    ...
    @Path("{id}")
    @Consumes({"application/xml", "application/json"})
    public void edit(@PathParam("id") String id, Commentaire entity) {
        super.edit(entity);
    }
    ...
    public Commentaire find(@PathParam("id") String id) {
